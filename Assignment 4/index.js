...
//USPS Format and General Format
...
var dropDownById = document.getElementById('university');
// var checkBoxOne = document.querySelectorAll('#campus-one');
// var checkBoxTwo = document.querySelectorAll('#campus-two');
...
dropDownById.addEventListener('change', function(e){
    ...
    switch(valueOfTheOption){
        ...
        case "northeastern":
            ...
            radioBoxOne[0].nextSibling.data = "Boston";
            radioBoxTwo[0].nextSibling.data = "Seattle";
        ...
        case "umass":
            radioBoxOne[0].style.display ="inline"
            radioBoxTwo[0].style.display = "inline";
            radioBoxOne[0].nextSibling.data = "Lowell";
            radioBoxTwo[0].nextSibling.data = "Amherst";
            university = "UMass";
        ...
        case "utexas":
            radioBoxOne[0].style.display ="inline"
            radioBoxTwo[0].style.display = "inline";
            radioBoxOne[0].nextSibling.data = "Dallas";
            radioBoxTwo[0].nextSibling.data = "Austin";
            university = "UTexas"
            conditonCheck == 0 ? conditonCheck = 1 : conditonCheck = 0;
            console.log("UTexas");
            break;
        ...
        case "ucal":
            radioBoxOne[0].style.display ="inline"
            radioBoxTwo[0].style.display = "inline";
            radioBoxOne[0].nextSibling.data = "Long Beach";
            radioBoxTwo[0].nextSibling.data = "Irvine";
            university = "UCal";
            console.log("UCal");
            break;
        ...
        case "tamu":
            radioBoxOne[0].style.display ="inline"
            radioBoxTwo[0].style.display = "inline";
            radioBoxOne[0].nextSibling.data = "Kingsville";
            radioBoxTwo[0].nextSibling.data = "Main";
            university = "TAMU";
            console.log("TAMU");
            break;
...
function showRadioBox(radioBoxId){
    ...
    window.localStorage.setItem("campus", valueOfRadioBox);
}

// var counter = 0;
// function showTextBox(checkBoxId){
//     var id2 = document.getElementById('text-box');
//     checkBoxId.checked ? counter++ : counter--;
//     id2.style.display = counter>0 ? "block" : "none";
//     counter>0 ? isCheckBoxesChecked = "true" : isCheckBoxesChecked =false;
// }
